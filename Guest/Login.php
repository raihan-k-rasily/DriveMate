...
<lang="en">
	...
	<body class="hero-wrap ftco-degree-bg" style="background-image: url('img/bg8');background-position: center center; background-size: cover;"
							...
							<form action="LoginAction.php" class="signin-form" method="POST">
								...
								<div class="form-group">
									<input id="password-field" type="password" name="txtpassword" class="form-control"
										placeholder="Password" required class="fa fa-fw fa-eye field-icon toggle-password" required>
								</div>
								<div class="form-group">
