        ...
        <div class="container">
            ...
            ?>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <a href="Model.php?id=<?php echo $display['Automakers_ID']; ?>" class="client__item">
                        <img src="../Uploads/<?php echo $display['Automakers_Image'];?>" style="width:200px; height: 100px;"  alt="">
                    </a>
                </div>
                <!-- <div class="col-lg-3 col-md-4 col-sm-6">
