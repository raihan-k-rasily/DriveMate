...
?>
    <!-- Hero Section Begin -->
    <section class="hero spad set-bg" data-setbg="img/bg10.jpg"  style=" background-position: center center; background-size: cover;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="hero__text">
                        <div class="hero__text__title">
                            ...
                            <h2><?php echo $_SESSION["Customer_Username"]; ?></h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix">
                    <div class="car__item">
                        ...
                        <div class="car__item__text">
                            ...
                            <a href="Model.php?id=<?php echo $display['Automakers_ID']; ?>">
                            <input type="button" class="btn btn-primary" name="btn_AutomakerDetails" value="Details">
                            </a>
                            </div>
                        </div>
                    </div>
